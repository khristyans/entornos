...
class Libreria:
    """Una clase para representar una librería de libros."""

    def __init__(self):
        """Inicializa una nueva instancia de Libreria."""
        self.libros = []
    ...
    def buscar_libro(self, titulo):
        ...
        Returns:
            list: Lista de libros encontrados que coinciden con el título dado.
        """
    ...
    def buscar_por_autor(self, autor):
        ...
        Returns:
            list: Lista de libros escritos por el autor dado.
        """
        
        return [libro for libro in self.libros if autor.lower()
                in libro['autor'].lower()]
